...
export const MIN_PAYMENT_AMOUNT_PAISE = 100; // ₹1

// ₹50,000 (change later if needed)
...
// Store processed webhook ids for 7 days
export const WEBHOOK_DEDUPE_TTL_SECONDS =
    60 * 60 * 24 * 7;
...
export const RAZORPAY_SIGNATURE_HEADER =
    "x-razorpay-signature";

export const RAZORPAY_EVENT_ID_HEADER =
    "x-razorpay-event-id";
...
export const DEFAULT_PAYOUT_MODE =
    PayoutMode.IMPS;

export const DEFAULT_PAYOUT_PURPOSE =
    "payout";