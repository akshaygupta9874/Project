...
export const getRefreshTokenRedisKey = (userId) => `${REFRESH_TOKEN_REDIS_KEY_PREFIX}:${userId}`;
export const getAccessTokenRedisKey = (userId) => `${ACCESS_TOKEN_REDIS_KEY_PREFIX}:${userId}`;
...
export const generateAccessToken = async (id, response) => {
    const ACCESS_TOKEN_SECRET = process.env.JWT_ACCESS_SECRET;
